...
public class DirectedSendRegistrationFieldsResponse  extends com.moneygram.www.AgentConnect1305.Response  implements java.io.Serializable {
    private com.moneygram.www.AgentConnect1305.FQDOInfo fqdoInfo;

    private com.moneygram.www.AgentConnect1305.RegistrationFieldInfo[] registrationFieldInfo;
    ...
    public DirectedSendRegistrationFieldsResponse(
           ...
           com.moneygram.www.AgentConnect1305.RegistrationFieldInfo[] registrationFieldInfo) {
        super(
            doCheckIn,
            timeStamp,
            flags);
     ...
     */
    public com.moneygram.www.AgentConnect1305.RegistrationFieldInfo[] getRegistrationFieldInfo() {
        return registrationFieldInfo;
    }
     ...
     */
    public void setRegistrationFieldInfo(com.moneygram.www.AgentConnect1305.RegistrationFieldInfo[] registrationFieldInfo) {
        this.registrationFieldInfo = registrationFieldInfo;
    }

    public com.moneygram.www.AgentConnect1305.RegistrationFieldInfo getRegistrationFieldInfo(int i) {
        return this.registrationFieldInfo[i];
    }

    public void setRegistrationFieldInfo(int i, com.moneygram.www.AgentConnect1305.RegistrationFieldInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.moneygram.com/AgentConnect1305", "DirectedSendRegistrationFieldsResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.moneygram.com/AgentConnect1305", "registrationFieldInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.moneygram.com/AgentConnect1305", "RegistrationFieldInfo"));
