...
public class DoddFrankStateRegulatorInfoResponse  extends com.moneygram.www.AgentConnect1305.Response  implements java.io.Serializable {
    private java.lang.String version;

    private com.moneygram.www.AgentConnect1305.StateRegulatorInfo[] stateRegulatorInfo;
    ...
    public DoddFrankStateRegulatorInfoResponse(
           ...
           com.moneygram.www.AgentConnect1305.StateRegulatorInfo[] stateRegulatorInfo) {
        super(
            doCheckIn,
            timeStamp,
            flags);
     ...
     */
    public com.moneygram.www.AgentConnect1305.StateRegulatorInfo[] getStateRegulatorInfo() {
        return stateRegulatorInfo;
    }
     ...
     */
    public void setStateRegulatorInfo(com.moneygram.www.AgentConnect1305.StateRegulatorInfo[] stateRegulatorInfo) {
        this.stateRegulatorInfo = stateRegulatorInfo;
    }

    public com.moneygram.www.AgentConnect1305.StateRegulatorInfo getStateRegulatorInfo(int i) {
        return this.stateRegulatorInfo[i];
    }

    public void setStateRegulatorInfo(int i, com.moneygram.www.AgentConnect1305.StateRegulatorInfo _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.moneygram.com/AgentConnect1305", "DoddFrankStateRegulatorInfoResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.moneygram.com/AgentConnect1305", "stateRegulatorInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.moneygram.com/AgentConnect1305", "stateRegulatorInfo"));
        elemField.setNillable(false);
